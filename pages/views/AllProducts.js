        ...
        return(
            ...
            <div class="row mb-3" style={{backgroundColor:'orange'}}>
                        <div class="col-3 mt-5">
                            ...
                            <a href="http://localhost:3000/auctions" class="btn btn-primary me-5"> Auctions </a>
                        </div>
                        <div class="col-6 mb-3">
                            <h4 class="text-center mb-5 mt-3">Below is all the available products</h4>
                            <form action="" class="">
                                    <form action="http://localhost:3000/products/search" method="POST">
                                    <div class="input-group">
                                        <input type="text" name = "search" onChange={event => {this.setState({search:event.target.value})}} value={this.state.search} class="form-control form-control-lg" placeholder="Search"/>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2 position-relative pt-3" style={{right:10, border:'3px solid rgb(0,255,255)'}}>
                                <h5 class="text-center text-primary mb-4">Price Range : </h5>
                                <form action="http://localhost:3000/products/range" method="POST" class="mb-5">
                                    <div class="mb-4">
                                        <div class="form-floating">
                                            <input type="number" id="name" class="form-control form-control-sm" placeholder='Enter Your Name' required min="0" name="min" />
                                            <label for="name">minimum</label>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <div class="form-floating">
                                            <input type="number" id="name" class="form-control form-control-sm" placeholder='Enter Your Name' required min="0" name="max" />
                                ...
                                <form action="http://localhost:3000/products/sort" method='POST'>
                                    <h5 class="text-center text-primary mb-4">Sort By : </h5>
                                        <div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="false" name="sort" id="flexRadioDefault1"/>
                                                <label class="form-check-label" for="flexRadioDefault1">
                                                    Increasing
                                                </label>
                                            </div>
                                            <div class="form-check mt-3">
                                                <input class="form-check-input" type="radio" value="true" name="sort" id="flexRadioDefault2"/>
