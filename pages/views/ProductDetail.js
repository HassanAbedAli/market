            ...
            <div class="col-md-6 col-md-offset-1 col-sm-12 col-xs-12">
                ...
                <div class="certified">
                    <ul>
                        ...
                        <li> PUT SALE PART HERE DATE DISCOUNT ETC STOCK WJAYEVER</li>
                    </ul>
                </div>
                <hr />
                ...
                <div class="description description-tabs">
                    <ul id="myTab" class="nav nav-pills">
                        ...
                        <li class=""><a href="#SellerDetails" data-toggle="tab">Seller Details</a></li>
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div class="tab-pane fade" id="SellerDetails">
                            <br />
                            <strong> Shop/Seller Name : </strong><hr/>
                            <strong> Phone Number : </strong><hr/>
                            <strong> Shop Location : </strong><hr/>
                            <strong> Link to Shop/Profile </strong>
                        </div>
